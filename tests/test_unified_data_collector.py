...
class TestUnifiedDataCollector(unittest.TestCase):
    ...
    @patch('src.data_collection.unified_data_collector.praw.Reddit')
    ...
    @patch('src.data_collection.unified_data_collector.yf.Ticker')
    ...
    @patch('src.data_collection.unified_data_collector.requests.get')
